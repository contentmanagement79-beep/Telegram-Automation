...
import { LogOut, Bot, KeyRound, MessageSquare, Package, MessagesSquare, Plug, Images, Clock, Users } from "lucide-react";
...
export default async function DashboardPage() {
  ...
  const cards = [
    ...
    { icon: Users, title: "Customers", body: "Everyone who messaged you + a short summary.", href: "/dashboard/customers" },
