...
export const demoScript: {
  ...
  { kind: "text", from: "customer", text: "Hi! Do you have the Next.js SaaS template?" },
  { kind: "text", from: "bot", text: "Hey! 👋 Yes — it's $49, with instant download after payment." },
  { kind: "voice", from: "customer", dur: "0:07" },
  { kind: "text", from: "bot", text: "Got your voice note — I can add the docs bundle too. Want that?" },
  { kind: "voice", from: "bot", dur: "0:05" },
  { kind: "text", from: "customer", text: "Perfect, sending payment now 🙌" },
];
